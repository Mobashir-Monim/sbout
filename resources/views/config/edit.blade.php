...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('config.update', ['config' => $config->id]) }}" method="POST" id="config-create">
                @csrf
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-4">
                            <div class="col-md-12">
                                <h4 class="border-bottom">Update Config</h4>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="display_name" class="form-control" placeholder="Display Name" value="{{ $config->display_name }}">
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <textarea name="description" class="form-control" cols="30" rows="3" placeholder="Description">{{ $config->description }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <div id="variable-editor" style="height: 400px">{{ json_encode($config->variable, JSON_PRETTY_PRINT) }}</div>
                            </div>
                        </div>
